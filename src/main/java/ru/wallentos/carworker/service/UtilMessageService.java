...
public class UtilMessageService {
    ...
    private String getKorexKrwMessageByResultData(CarPriceResultData resultData) {
        return String.format(Locale.FRANCE, """
                        ...
                        По вопросам заказа авто вы можете обратиться к нашему менеджеру @Korex_Consultant.
    ...
    private String getKorexCnyMessageByResultData(CarPriceResultData resultData) {
        return String.format(Locale.FRANCE, """
                        ...
                        По вопросам проведения платежа и заказа авто вы можете обратиться к нашему менеджеру @Korex_Consultant.
    ...
    private String getEastWayCnyMessageByResultData(CarPriceResultData resultData) {
        return String.format(Locale.FRANCE, """
                                                ...
                                                Таможенная пошлина: %,.0f ₽

                                                Утилизационный сбор: %d ₽               
    ...
    private String getMCarKrwMessageByResultData(CarPriceResultData resultData) {
        return String.format(Locale.FRANCE, """
                        ...
                        <u><b>%,.0f ₽</b></u>
                        %s
                        Стоимость "под ключ" включает в себя все расходы до г. Владивосток, а именно: оформление экспорта в Корее, логистику, услуги брокера, склады временного хранения, прохождение лаборатории для получения СБКТС и таможенную пошлину.
